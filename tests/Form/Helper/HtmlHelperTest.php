...
class HtmlHelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMakeHtml()
    {
        ...
        $this->assertEquals(
            '<div id="element-name-grid" class="col-xs-12 col-sm-6" ><div id="element-name-form-group" class="form-group danger required" ><label for="element-id">  <a id="element-id_help" class="btn-help" tabindex="0" data-placement="top" role="button" data-toggle="popover" data-trigger="hover" title="Descrição" data-content="Description">Element for Test <i class="fa fa-question-circle"></i></a> <script>jQuery( document ).ready(function() { jQuery(\'#element-id_help\').popover(); });</script></label><div class="before-input"><input id="element-id" /></div><div class="error-message" id="element-name-input-message"></div><script> jQuery(document).ready(function() { jQuery("#element-id").mask("#0,00", { reverse: true }); });</script></div><script>console.log("teste");</script></div>',

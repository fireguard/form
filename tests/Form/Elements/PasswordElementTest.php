...
class PasswordElementTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals(
            '<div id="name-for-input-text-form-group" class="form-group" ><input name="name-for-input-text" id="name-for-input-text-id" value="" type="password" class="form-control "><div class="error-message" id="name-for-input-text-input-message"></div></div>',
            $this->element->render()
        );
    }
}
